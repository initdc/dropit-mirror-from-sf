...
InfoBeforeFile=..\DropIt_v0.7.2_Portable\docs\Readme.txt
OutputDir=..\
OutputBaseFilename=DropIt_v0.7.2_Setup
...
[Files]
Source: "..\DropIt_v0.7.2_Portable\DropIt.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\DropIt_v0.7.2_Portable\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
