...
InfoBeforeFile=..\DropIt_v0.9_Portable\docs\Readme.txt
OutputDir=..\
OutputBaseFilename=DropIt_v0.9_Setup
...
[Files]
Source: "..\DropIt_v0.9_Portable\DropIt.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\DropIt_v0.9_Portable\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
