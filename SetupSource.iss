...
InfoBeforeFile=..\DropIt_v0.7.1_Portable\docs\Readme.txt
OutputDir=..\
OutputBaseFilename=DropIt_v0.7.1_Setup
...
[Files]
Source: "..\DropIt_v0.7.1_Portable\DropIt.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\DropIt_v0.7.1_Portable\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
